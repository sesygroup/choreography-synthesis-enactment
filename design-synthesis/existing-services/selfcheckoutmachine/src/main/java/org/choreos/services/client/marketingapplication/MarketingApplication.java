...
public interface MarketingApplication {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "scenarioSetup", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ScenarioSetup")
    @ResponseWrapper(localName = "scenarioSetupResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ScenarioSetupResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "basicCommDeviceSubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.BasicCommDeviceSubscribe")
    @ResponseWrapper(localName = "basicCommDeviceSubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.BasicCommDeviceSubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "shopAssistAppSubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ShopAssistAppSubscribe")
    @ResponseWrapper(localName = "shopAssistAppSubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ShopAssistAppSubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "shopAssistAppUnsubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ShopAssistAppUnsubscribe")
    @ResponseWrapper(localName = "shopAssistAppUnsubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ShopAssistAppUnsubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "basicCommDeviceUnsubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.BasicCommDeviceUnsubscribe")
    @ResponseWrapper(localName = "basicCommDeviceUnsubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.BasicCommDeviceUnsubscribeResponse")
    ...
    @RequestWrapper(localName = "unsubscribeto_supply_authorization", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.UnsubscribetoSupplyAuthorization")
    @ResponseWrapper(localName = "unsubscribeto_supply_authorizationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.UnsubscribetoSupplyAuthorizationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "publicOfferConfirmation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.PublicOfferConfirmation")
    @ResponseWrapper(localName = "publicOfferConfirmationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.PublicOfferConfirmationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "proposeAlternative", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ProposeAlternative")
    @ResponseWrapper(localName = "proposeAlternativeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ProposeAlternativeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "authorize", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.Authorize")
    @ResponseWrapper(localName = "authorizeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.AuthorizeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "communicateAnswers", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.CommunicateAnswers")
    @ResponseWrapper(localName = "communicateAnswersResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.CommunicateAnswersResponse")
    ...
    @RequestWrapper(localName = "set_estimate", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SetEstimate")
    @ResponseWrapper(localName = "set_estimateResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SetEstimateResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "addProductNotify", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.AddProductNotify")
    @ResponseWrapper(localName = "addProductNotifyResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.AddProductNotifyResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "notifyCheckin", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.NotifyCheckin")
    @ResponseWrapper(localName = "notifyCheckinResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.NotifyCheckinResponse")
    ...
    @RequestWrapper(localName = "unsubscribe_to_sales_estimation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.UnsubscribeToSalesEstimation")
    @ResponseWrapper(localName = "unsubscribe_to_sales_estimationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.UnsubscribeToSalesEstimationResponse")
    ...
    @RequestWrapper(localName = "ma_receive_sms", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.MaReceiveSms")
    @ResponseWrapper(localName = "ma_receive_smsResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.MaReceiveSmsResponse")
    ...
    @RequestWrapper(localName = "subscribe_to_sales_estimation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SubscribeToSalesEstimation")
    @ResponseWrapper(localName = "subscribe_to_sales_estimationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SubscribeToSalesEstimationResponse")
    ...
    @RequestWrapper(localName = "subscribe_to_supply_authorization", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SubscribeToSupplyAuthorization")
    @ResponseWrapper(localName = "subscribe_to_supply_authorizationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SubscribeToSupplyAuthorizationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "notifyCheckout", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.NotifyCheckout")
    @ResponseWrapper(localName = "notifyCheckoutResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.NotifyCheckoutResponse")
    ...
    @RequestWrapper(localName = "shopping_list_communication", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ShoppingListCommunication")
    @ResponseWrapper(localName = "shopping_list_communicationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ShoppingListCommunicationResponse")
    ...
    @RequestWrapper(localName = "unsubscribe_to_supply_negotiation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.UnsubscribeToSupplyNegotiation")
    @ResponseWrapper(localName = "unsubscribe_to_supply_negotiationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.UnsubscribeToSupplyNegotiationResponse")
    ...
    @RequestWrapper(localName = "subscribe_to_supply_negotation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SubscribeToSupplyNegotation")
    @ResponseWrapper(localName = "subscribe_to_supply_negotationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SubscribeToSupplyNegotationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "storeBoughtItems", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.StoreBoughtItems")
    @ResponseWrapper(localName = "storeBoughtItemsResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.StoreBoughtItemsResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "changeQtyNotify", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ChangeQtyNotify")
    @ResponseWrapper(localName = "changeQtyNotifyResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.ChangeQtyNotifyResponse")
    ...
    @RequestWrapper(localName = "make_proposal", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.MakeProposal")
    @ResponseWrapper(localName = "make_proposalResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.MakeProposalResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "privateOfferConfirmation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.PrivateOfferConfirmation")
    @ResponseWrapper(localName = "privateOfferConfirmationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.PrivateOfferConfirmationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "removeProductNotify", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.RemoveProductNotify")
    @ResponseWrapper(localName = "removeProductNotifyResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.RemoveProductNotifyResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "put", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.Put")
    @ResponseWrapper(localName = "putResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.PutResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "setInvocationAddress", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SetInvocationAddress")
    @ResponseWrapper(localName = "setInvocationAddressResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SetInvocationAddressResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "setEndpointAddress", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SetEndpointAddress")
    @ResponseWrapper(localName = "setEndpointAddressResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.marketingapplication.SetEndpointAddressResponse")
