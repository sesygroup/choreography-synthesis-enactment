...
public interface Shoppingassistantapp {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "scenarioSetup", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.ScenarioSetup")
    @ResponseWrapper(localName = "scenarioSetupResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.ScenarioSetupResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "shopAssistAppSubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.ShopAssistAppSubscribe")
    @ResponseWrapper(localName = "shopAssistAppSubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.ShopAssistAppSubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "shopAssistAppUnsubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.ShopAssistAppUnsubscribe")
    @ResponseWrapper(localName = "shopAssistAppUnsubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.ShopAssistAppUnsubscribeResponse")
    ...
    @RequestWrapper(localName = "private_offer", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.PrivateOffer")
    @ResponseWrapper(localName = "private_offerResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.PrivateOfferResponse")
    ...
    @RequestWrapper(localName = "record_bought_items", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.RecordBoughtItems")
    @ResponseWrapper(localName = "record_bought_itemsResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.RecordBoughtItemsResponse")
    ...
    @RequestWrapper(localName = "communicate_questionnaire", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.CommunicateQuestionnaire")
    @ResponseWrapper(localName = "communicate_questionnaireResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.CommunicateQuestionnaireResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "remind", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.Remind")
    @ResponseWrapper(localName = "remindResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.RemindResponse")
    ...
    @RequestWrapper(localName = "communicate_incentive", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.CommunicateIncentive")
    @ResponseWrapper(localName = "communicate_incentiveResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.CommunicateIncentiveResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "setInvocationAddress", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.SetInvocationAddress")
    @ResponseWrapper(localName = "setInvocationAddressResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.SetInvocationAddressResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "setEndpointAddress", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.SetEndpointAddress")
    @ResponseWrapper(localName = "setEndpointAddressResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.client.shoppingassistantapp.SetEndpointAddressResponse")
