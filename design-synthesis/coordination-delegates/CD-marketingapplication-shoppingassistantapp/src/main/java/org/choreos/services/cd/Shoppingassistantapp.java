...
public interface Shoppingassistantapp {
    ...
    @RequestWrapper(localName = "private_offer", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PrivateOffer")
    @ResponseWrapper(localName = "private_offerResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PrivateOfferResponse")
    ...
    @RequestWrapper(localName = "record_bought_items", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.RecordBoughtItems")
    @ResponseWrapper(localName = "record_bought_itemsResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.RecordBoughtItemsResponse")
    ...
    @RequestWrapper(localName = "communicate_questionnaire", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.CommunicateQuestionnaire")
    @ResponseWrapper(localName = "communicate_questionnaireResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.CommunicateQuestionnaireResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "remind", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.Remind")
    @ResponseWrapper(localName = "remindResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.RemindResponse")
    ...
    @RequestWrapper(localName = "communicate_incentive", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.CommunicateIncentive")
    @ResponseWrapper(localName = "communicate_incentiveResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.CommunicateIncentiveResponse")
