...
public interface MarketingApplication {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "basicCommDeviceSubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.BasicCommDeviceSubscribe")
    @ResponseWrapper(localName = "basicCommDeviceSubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.BasicCommDeviceSubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "shopAssistAppSubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ShopAssistAppSubscribe")
    @ResponseWrapper(localName = "shopAssistAppSubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ShopAssistAppSubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "shopAssistAppUnsubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ShopAssistAppUnsubscribe")
    @ResponseWrapper(localName = "shopAssistAppUnsubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ShopAssistAppUnsubscribeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "basicCommDeviceUnsubscribe", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.BasicCommDeviceUnsubscribe")
    @ResponseWrapper(localName = "basicCommDeviceUnsubscribeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.BasicCommDeviceUnsubscribeResponse")
    ...
    @RequestWrapper(localName = "unsubscribeto_supply_authorization", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.UnsubscribetoSupplyAuthorization")
    @ResponseWrapper(localName = "unsubscribeto_supply_authorizationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.UnsubscribetoSupplyAuthorizationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "publicOfferConfirmation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PublicOfferConfirmation")
    @ResponseWrapper(localName = "publicOfferConfirmationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PublicOfferConfirmationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "proposeAlternative", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ProposeAlternative")
    @ResponseWrapper(localName = "proposeAlternativeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ProposeAlternativeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "authorize", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.Authorize")
    @ResponseWrapper(localName = "authorizeResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.AuthorizeResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "communicateAnswers", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.CommunicateAnswers")
    @ResponseWrapper(localName = "communicateAnswersResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.CommunicateAnswersResponse")
    ...
    @RequestWrapper(localName = "set_estimate", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SetEstimate")
    @ResponseWrapper(localName = "set_estimateResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SetEstimateResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "addProductNotify", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.AddProductNotify")
    @ResponseWrapper(localName = "addProductNotifyResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.AddProductNotifyResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "notifyCheckin", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.NotifyCheckin")
    @ResponseWrapper(localName = "notifyCheckinResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.NotifyCheckinResponse")
    ...
    @RequestWrapper(localName = "unsubscribe_to_sales_estimation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.UnsubscribeToSalesEstimation")
    @ResponseWrapper(localName = "unsubscribe_to_sales_estimationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.UnsubscribeToSalesEstimationResponse")
    ...
    @RequestWrapper(localName = "ma_receive_sms", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.MaReceiveSms")
    @ResponseWrapper(localName = "ma_receive_smsResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.MaReceiveSmsResponse")
    ...
    @RequestWrapper(localName = "subscribe_to_sales_estimation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SubscribeToSalesEstimation")
    @ResponseWrapper(localName = "subscribe_to_sales_estimationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SubscribeToSalesEstimationResponse")
    ...
    @RequestWrapper(localName = "subscribe_to_supply_authorization", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SubscribeToSupplyAuthorization")
    @ResponseWrapper(localName = "subscribe_to_supply_authorizationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SubscribeToSupplyAuthorizationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "notifyCheckout", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.NotifyCheckout")
    @ResponseWrapper(localName = "notifyCheckoutResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.NotifyCheckoutResponse")
    ...
    @RequestWrapper(localName = "shopping_list_communication", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ShoppingListCommunication")
    @ResponseWrapper(localName = "shopping_list_communicationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ShoppingListCommunicationResponse")
    ...
    @RequestWrapper(localName = "unsubscribe_to_supply_negotiation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.UnsubscribeToSupplyNegotiation")
    @ResponseWrapper(localName = "unsubscribe_to_supply_negotiationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.UnsubscribeToSupplyNegotiationResponse")
    ...
    @RequestWrapper(localName = "subscribe_to_supply_negotation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SubscribeToSupplyNegotation")
    @ResponseWrapper(localName = "subscribe_to_supply_negotationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.SubscribeToSupplyNegotationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "storeBoughtItems", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.StoreBoughtItems")
    @ResponseWrapper(localName = "storeBoughtItemsResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.StoreBoughtItemsResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "changeQtyNotify", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ChangeQtyNotify")
    @ResponseWrapper(localName = "changeQtyNotifyResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.ChangeQtyNotifyResponse")
    ...
    @RequestWrapper(localName = "make_proposal", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.MakeProposal")
    @ResponseWrapper(localName = "make_proposalResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.MakeProposalResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "privateOfferConfirmation", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PrivateOfferConfirmation")
    @ResponseWrapper(localName = "privateOfferConfirmationResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PrivateOfferConfirmationResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "removeProductNotify", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.RemoveProductNotify")
    @ResponseWrapper(localName = "removeProductNotifyResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.RemoveProductNotifyResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "put", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.Put")
    @ResponseWrapper(localName = "putResponse", targetNamespace = "http://services.choreos.org/", className = "org.choreos.services.cd.PutResponse")
