...
package org.choreos.services.startchoreography.client;
 ...
 * generated in the org.choreos.services.startWP7Choreography.client.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Start_QNAME = new QName("http://services.choreos.org/", "start");
    ...
    private final static QName _StartResponse_QNAME = new QName("http://services.choreos.org/", "startResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.choreos.services.startWP7Choreography.client.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.choreos.org/", name = "start")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.choreos.org/", name = "startResponse")
